    ...
    return (
        <div>
            <div className="max-w-7xl mx-auto">
                <h3 className="text-5xl text-center font-bold pt-10 text-[#FA8072]">About Us</h3>
                <p className="mx-auto text-center text-lg font-semibold mt-3 max-w-xl">Welcome to Food Palace, where passion for food and a commitment to creating memorable dining experiences come together.</p>
                <div className="flex flex-col-reverse md:flex-row lg:flex-row items-center gap-10 mt-10 px-5 lg:px-0">
                    ...
                    <div className="grid grid-cols-2 gap-3 w-full md:w-1/2">
                        <div className="grid gap-3 grid-cols-1">
                            <img src="https://i.ibb.co/6wftNDH/pub-promo-with-delicious-burger.jpg" alt="burger" className="h-[450px] rounded-l-lg" />
                            <img src="https://i.ibb.co/QjGLKQV/ready-eat-meals-arrangement.jpg" alt="meat" className="rounded-l-lg" />
                        </div>
                        <div className="grid gap-3 rounded-lg grid-cols-1">
                            <img src="https://i.ibb.co/sKZtQTX/ready-eat-meals-arrangement-1.jpg" alt="" className="h-[450px] w-full rounded-r-lg" />
                            <img src="https://i.ibb.co/LvTvxZR/ready-eat-meal-collage-design.jpg" alt="green" className="rounded-r-lg" />
                        </div>
